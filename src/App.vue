...
import { imageToURL } from '@antv/g6';
        ...
        draw(cfg, group) {
          ...
          var a=group.addShape("rect", {
            attrs: {
              ...
              height: 30,
              width,
              radius: [boxStyle.tableHeadCss.radius, boxStyle.tableHeadCss.radius, boxStyle.tableHeadCss.radius, boxStyle.tableHeadCss.radius],
            },
            draggable: true,
          });
